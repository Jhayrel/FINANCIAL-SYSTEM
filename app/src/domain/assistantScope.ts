...
export function capabilitiesAnswer(): string {
  return [
    ...
    "- **Answer questions and advise** from your own figures, including what if: \"what if I buy a 25k phone\", \"how much did I spend from sep 1 to 15\".",
    "- **Draw charts** over any window, as bars, a pie or a line: \"chart today\", \"this week's trend\", \"last 10 days\", \"since august\", \"sep 1 to sep 15\", \"this quarter\", \"daily spending in august\", \"income vs spending this year\".",
